        ...
        if attr != "":
            ...
            for x in drs_attr:
                if x.nid not in candidate_columns:
                    col = Column(x)
                    # col.examples_set = inputted examples into method
                    # TODO: find common values between x and attr (query column- list of examples inputted)
